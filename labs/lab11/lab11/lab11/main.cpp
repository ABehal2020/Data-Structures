...
int main() {
    ...
    //
    assert (a > b); // flexible beats flying
    assert(c > d); // invisible beats laser
    ...
    // for superhero class, creative operator that can be overloaded is *
    // this way we can give the superheroes multple powers (either change it to a vector of powers or just concatenate it to the string) to make them stronger
